                ...
                <ul class="nav nav-pills float-right">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="NuevaOrden.jsp"
                            style="color: rgb(82, 94, 169); background-color: rgb(255, 255, 255);">Nueva Orden</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Reportes.jsp"
                            style="color: rgb(226, 229, 236); background-color: rgb(82, 94, 169);">Reporte por
                            Medicamento</a>
                    </li>
                </ul>
            </nav>
        ...
        <div class="m-5">
            <div class="row" style="">
                ...
                <div class=" col-5 col-sm-8">
                    ...
                    <h3></h3>
                    <h5 style="float: none;">Generar reporte por medicamento</h5>
